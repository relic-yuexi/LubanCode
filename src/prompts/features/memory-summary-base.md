...
```
{"task_type":"code|research|config|docs|other","summary":"不超过 120 字的回合总结","retrieval_terms":["下一轮检索用的关键词或同义改写,最多 8 个"],"candidates":[{"kind":"fact|preference","title":"短主题","summary":"一行摘要","content":"精炼正文","keywords":["精确检索词"],"paths":["支撑证据的项目内相对路径"],"confidence":"user-stated|verified|inferred"}]}
```
