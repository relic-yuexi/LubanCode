...
const Entry kZhCN[] = {
    ...
    {"doctor.search.fix",
     "修复: python scripts/fetch_ripgrep.py --target <home>/.lubancode/rg-stage(一次,全机共享;补齐后自动兜底,无需随包)"},
    {"doctor.search.note",
...
const Entry kEn[] = {
    ...
    {"doctor.search.fix",
     "fix: python scripts/fetch_ripgrep.py --target <home>/.lubancode/rg-stage (once, shared machine-wide; search then self-heals to it, no bundle needed)"},
    {"doctor.search.note",
