...
const Entry kZhCN[] = {
    ...
    {"slash.desc.evolve", "自进化闭环:status 采集观察,list 按指纹聚类,propose 起草候选(簇够门槛出组合包),test 评测,approve/use/promote/rollback 批准与灰度"},
...
const Entry kEn[] = {
    ...
    {"slash.desc.evolve", "self-evolution loop: status collects observations, list clusters by fingerprint, propose drafts candidates (combo package once the cluster clears the bar), test evaluates, approve/use/promote/rollback gate & roll"},
