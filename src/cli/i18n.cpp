...
const Entry kZhCN[] = {
    ...
    {"search.keys_hint", "Ctrl+R 更早 · Ctrl+S 换范围 · Tab/Esc 取回 · Enter 取回并发送 · Ctrl+C 取消"},
    {"search.query", "查询"},
...
const Entry kEn[] = {
    ...
    {"search.keys_hint", "Ctrl+R older · Ctrl+S scope · Tab/Esc recall · Enter recall & send · Ctrl+C cancel"},
    {"search.query", "query"},
