...
const Entry kZhCN[] = {
    ...
    {"cmd.insights.ledger_off",
     "洞察报告账未开(features.trajectory 关):Journal 一笔没记,/insights 无账可扫。开 features.trajectory 攒真账后再来。"},
...
const Entry kEn[] = {
    ...
    {"cmd.insights.ledger_off",
     "Insights ledger is off (features.trajectory off): the journal has no entries, /insights has nothing to scan. Enable features.trajectory to collect real data first."},
    {"cmd.insights.later_model_review",
