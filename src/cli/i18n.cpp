...
const Entry kZhCN[] = {
    ...
    {"agent_status.state_exhausted", "耗尽 · {0}/{1} 轮"},
    {"agent_status.budget_suffix", " · {0}/{1} 轮"},
    {"agent_status.reason_api_error", "接口报错"},
    {"agent_status.reason_max_turns", "轮数耗尽"},
    ...
    {"error.turn_limit", "已达配置的轮数上限(本轮实际跑了 {0} 次),可调大上限或设 0 解除。"},
...
const Entry kEn[] = {
    ...
    {"agent_status.state_exhausted", "exhausted · {0}/{1} turns"},
    {"agent_status.budget_suffix", " · {0}/{1} turns"},
    {"agent_status.reason_api_error", "API error"},
    {"agent_status.reason_max_turns", "turn budget exhausted"},
    ...
    {"error.turn_limit", "Configured turn limit reached ({0} requests this turn); raise the limit or set 0 to remove it."},
