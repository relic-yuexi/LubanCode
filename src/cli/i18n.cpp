...
const Entry kZhCN[] = {
    ...
    {"cmd.think.wire_shape", "落线形状: {0} {1}"},
    {"cmd.think.wire_legacy", "落线形状: 目录未声明方言,走兼容形状(未验证)。"},
    {"cmd.think.wire_verified", "[已验证]"},
    {"cmd.think.wire_unverified", "[未验证]"},
    ...
    {"doctor.effort.dialect_verified", "[方言已验证]"},
    {"doctor.effort.dialect_unverified", "[方言未验证]"},
    {"doctor.effort.dialect_legacy", "[无方言声明,走兼容形状]"},
