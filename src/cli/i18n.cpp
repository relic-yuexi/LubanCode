...
const Entry kZhCN[] = {
    ...
    {"slash.desc.evolve", "自进化观察账:status 采集并报账,list 按指纹聚类,show 追根(不生成 Package)"},
...
const Entry kEn[] = {
    ...
    {"slash.desc.evolve", "evolution observations: status collects & reports, list clusters by fingerprint, show traces source (no Package drafting)"},
