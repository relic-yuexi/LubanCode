...
inline constexpr const char* kEventLoopIterationStarted = "loop_iteration_started";
inline constexpr const char* kEventLoopIterationCompleted = "loop_iteration_completed";
