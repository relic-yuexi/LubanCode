...
constexpr PayloadField kPayloadFields[] = {
    ...
    // workflow 编排单(§3.6"node JSONL 的第一行带"):workflow run 与
    // node attempt 的 run.started 首行身份键。只在 workflows/ 树的 stream
    // 出现;旧读者遇新键按未知字段拒,与超前版本同待遇。
    {EventKind::RunStarted, "workflow_run_id", "s", false},
    {EventKind::RunStarted, "workflow_id", "s", false},
    {EventKind::RunStarted, "node_id", "s", false},
    {EventKind::RunStarted, "node_kind", "s", false},
    {EventKind::RunStarted, "attempt", "u", false},
    {EventKind::RunStarted, "map_item_index", "i|", false},
    {EventKind::RunStarted, "loop_iteration", "u", false},
    {EventKind::RunStarted, "branch_path", "s|", false},
    ...
    // workflow 编排账(workflow 会话归属统一单,§3.6):编排 Journal 专用
    // 事实族。node 派发/终态经 relations.child_run_id 引 node stream
    //(verifier 交叉核);正文只记编排身份与结果摘要,输入输出走 sha 引
    // 用,不内联大正文(正文归 node stream 与 checkpoints)。
    {EventKind::WorkflowDefinitionLoaded, "workflow_id", "s", true},
    {EventKind::WorkflowDefinitionLoaded, "content_hash", "s", true},
    {EventKind::WorkflowDefinitionLoaded, "workflow_version", "s", false},
    {EventKind::WorkflowDefinitionLoaded, "node_count", "u", false},
    {EventKind::WorkflowDefinitionLoaded, "entry", "s", false},
    {EventKind::WorkflowNodeDispatched, "node_id", "s", true},
    {EventKind::WorkflowNodeDispatched, "node_run_id", "s", true},
    {EventKind::WorkflowNodeDispatched, "attempt", "u", true},
    {EventKind::WorkflowNodeDispatched, "node_kind", "s", true},
    {EventKind::WorkflowNodeDispatched, "map_item_index", "i|", false},
    {EventKind::WorkflowNodeDispatched, "input_sha256", "s", false},
    {EventKind::WorkflowNodeRetrying, "node_id", "s", true},
    {EventKind::WorkflowNodeRetrying, "node_run_id", "s", true},
    {EventKind::WorkflowNodeRetrying, "attempt", "u", true},
    {EventKind::WorkflowNodeRetrying, "max_attempts", "u", true},
    {EventKind::WorkflowNodeRetrying, "code", "s", true},
    {EventKind::WorkflowNodeWaiting, "node_id", "s", true},
    {EventKind::WorkflowNodeWaiting, "wait_kind", "s", true},
    {EventKind::WorkflowNodeWaiting, "body", "s", false},
    {EventKind::WorkflowNodeCompleted, "node_id", "s", true},
    {EventKind::WorkflowNodeCompleted, "node_run_id", "s", true},
    {EventKind::WorkflowNodeCompleted, "attempt", "u", true},
    {EventKind::WorkflowNodeCompleted, "outcome", "s", true},
    {EventKind::WorkflowNodeCompleted, "duration_ms", "i", false},
    {EventKind::WorkflowNodeCompleted, "tokens", "i", false},
    {EventKind::WorkflowNodeCompleted, "agent", "s", false},
    {EventKind::WorkflowNodeCompleted, "output_sha256", "s", false},
    {EventKind::WorkflowNodeCompleted, "child_terminal_event_hash", "s", false},
    {EventKind::WorkflowNodeFailed, "node_id", "s", true},
    {EventKind::WorkflowNodeFailed, "node_run_id", "s", true},
    {EventKind::WorkflowNodeFailed, "attempt", "u", true},
    {EventKind::WorkflowNodeFailed, "code", "s", true},
    {EventKind::WorkflowNodeFailed, "error", "s", false},
    {EventKind::WorkflowNodeFailed, "duration_ms", "i", false},
    {EventKind::WorkflowNodeFailed, "tokens", "i", false},
    {EventKind::WorkflowNodeFailed, "child_terminal_event_hash", "s", false},
    {EventKind::WorkflowNodeSkipped, "node_id", "s", true},
    {EventKind::WorkflowNodeSkipped, "node_run_id", "s", false},
    {EventKind::WorkflowNodeSkipped, "reason", "s", false},
    {EventKind::WorkflowBranchStarted, "node_id", "s", true},
    {EventKind::WorkflowBranchStarted, "branches", "a", true},
    {EventKind::WorkflowBranchStarted, "concurrency", "u", false},
    {EventKind::WorkflowJoinCompleted, "node_id", "s", true},
    {EventKind::WorkflowJoinCompleted, "join", "s", false},
    {EventKind::WorkflowJoinCompleted, "succeeded", "u", false},
    {EventKind::WorkflowJoinCompleted, "failed", "u", false},
    {EventKind::WorkflowJoinCompleted, "unavailable", "a", false},
    {EventKind::WorkflowLoopIterationStarted, "node_id", "s", true},
    {EventKind::WorkflowLoopIterationStarted, "iteration", "u", true},
    {EventKind::WorkflowLoopIterationCompleted, "node_id", "s", true},
    {EventKind::WorkflowLoopIterationCompleted, "iteration", "u", true},
