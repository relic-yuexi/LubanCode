...
//   5. permissions:inherit = 同父;宽窄序 confirm < auto < yolo,比父宽
//      报 agent.permission_widening(契约 §4.9 铁律)。
...
struct AgentProfileResolveEnvironment {
    AgentPermissionMode parent_permission = AgentPermissionMode::Confirm;
