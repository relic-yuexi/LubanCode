...
#include "agent/agent.hpp"  // /doctor 的运行档案(ctx.main_agent->runtime_profile)
#include "app/tool_runtime.hpp"  // explore_registry(/doctor search 的能力面)
#include "runtime/session_runtime.hpp"  // wire 名(/doctor trajectory 的身份行)
