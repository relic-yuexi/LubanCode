...
对应设计单 是新版设计总纲，早期验收记录保留日期，不删历史红项来伪造一次通过。D1/D2/D3 后续修复以当前源码和发行记录核实；§4.67–4.71 新增设计不能因总纲写“已完结”就算落地。LuaHook、AppServer、Workflow 关联单仍各有实施阶段。旧 workspace-storage-v2 快照已逐页标记，新设计单不因文件名含旧术语而整份作废。
